/**
  ...
  ******************************************************************************
  */
#ifndef AI_FAILURE_PREDICTION_H
#define AI_FAILURE_PREDICTION_H

#include "failure_prediction_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_FAILURE_PREDICTION_MODEL_NAME          "failure_prediction"
#define AI_FAILURE_PREDICTION_ORIGIN_MODEL_NAME   "failure_prediction_model"

/******************************************************************************/
#define AI_FAILURE_PREDICTION_ACTIVATIONS_ALIGNMENT   (4)
#define AI_FAILURE_PREDICTION_INPUTS_IN_ACTIVATIONS   (4)
#define AI_FAILURE_PREDICTION_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_FAILURE_PREDICTION_IN_NUM        (1)

AI_DEPRECATED
#define AI_FAILURE_PREDICTION_IN \
  ai_failure_prediction_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_FAILURE_PREDICTION_IN_SIZE { \
  AI_FAILURE_PREDICTION_IN_1_SIZE, \
}
#define AI_FAILURE_PREDICTION_IN_SIZE_BYTES { \
  AI_FAILURE_PREDICTION_IN_1_SIZE_BYTES, \
}
#define AI_FAILURE_PREDICTION_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_FAILURE_PREDICTION_IN_1_CHANNEL     (5)
#define AI_FAILURE_PREDICTION_IN_1_SIZE        (5)
#define AI_FAILURE_PREDICTION_IN_1_SIZE_BYTES  (20)

/******************************************************************************/
#define AI_FAILURE_PREDICTION_OUT_NUM       (1)

AI_DEPRECATED
#define AI_FAILURE_PREDICTION_OUT \
  ai_failure_prediction_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_FAILURE_PREDICTION_OUT_SIZE { \
  AI_FAILURE_PREDICTION_OUT_1_SIZE, \
}
#define AI_FAILURE_PREDICTION_OUT_SIZE_BYTES { \
  AI_FAILURE_PREDICTION_OUT_1_SIZE_BYTES, \
}
#define AI_FAILURE_PREDICTION_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_FAILURE_PREDICTION_OUT_1_CHANNEL     (5)
#define AI_FAILURE_PREDICTION_OUT_1_SIZE        (5)
#define AI_FAILURE_PREDICTION_OUT_1_SIZE_BYTES  (20)

/******************************************************************************/
#define AI_FAILURE_PREDICTION_N_NODES (8)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup failure_prediction
 ...
 * @ref ai_failure_prediction_create. Both the activations memory buffer 
 ...
 * using @ref ai_failure_prediction_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_failure_prediction_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_failure_prediction_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_FAILURE_PREDICTION_*
 * defines into file @ref failure_prediction.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_failure_prediction_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_FAILURE_PREDICTION_H */
